...
/**
 * Servlet implementation class QueryInPageStudentsBySnameServlet
 */
public class QueryInPageStudentsBySnameServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public QueryInPageStudentsBySnameServlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getParameter("sname") != null) {
			name = (String) (request.getParameter("sname"));
			NAME = name;
		} else {
			name = NAME;
		}
...
//		String pSize = request.getParameter("pageSize");
		...
		int count = studentService.getSnameCount(name);// 总数
...
//			pSizeJSP = request.getParameter("pageSizeJSP");
		...
		List<Student> students = studentService.queryInPageStudentsBySname(name, currentPage, pageSize);// 分页查询
		...
		request.getRequestDispatcher("studentInfoQueryInPage/studentInfoQueryInPageBySname.jsp").forward(request,
				response);
